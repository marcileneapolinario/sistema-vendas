    ...
    public function vendas() {
        ...
        if($data_inicial){
            ...
            if($this->vendas_model->gerar_relatorio_vendas($data_inicial, $data_final)){
                ...
                $file_name = 'Relatórios de vendas';
                ...
                ' . $empresa->sistema_endereco . ', &nbsp;' . $empresa->sistema_numero . ', &nbsp;  CEP: ' . $empresa->sistema_cep . ', &nbsp;' . $empresa->sistema_cidade . ', &nbsp;' . $empresa->sistema_estado . '<br/>
                ' . 'Telefone: ' . $empresa->sistema_telefone_fixo . ' E-mail: ' . $empresa->sistema_email . '<br/>
                    </h4>';
                ...
                if($data_inicial && $data_final){
                    ...
                    $html .= '<p align="center "style="font-size: 12px">Relatório de vendas realizadas a partir de: </p>';
...
//                        . '</p>';
                ...
                if(!empty($data_inicial)&& !empty($data_final) ){
                   $this->session->set_flashdata('info', 'Não foram encontradas Vendas entre as datas ' . formata_data_banco_sem_hora($data_inicial).'&nbsp;&nbsp;'. formata_data_banco_sem_hora($data_final)); 
                }else{
    ...
    public function os() {
        ...
        if($data_inicial){
            ...
            if($this->ordem_servicos_model->gerar_relatorio_os($data_inicial, $data_final)){
                ...
                $file_name = 'Relatórios de serviços';
                ...
                if($data_inicial && $data_final){
                    ...
                    $html .= '<p align="center "style="font-size: 12px">Relatório de serviços realizados entre as seguintes datas: </p>';
                    $html .= '<p align="center" style="font-size: 12px">'. formata_data_banco_sem_hora($data_inicial).' - ' . formata_data_banco_sem_hora($data_final). '</p>';
                }else{
                    
                    $html .= '<p align="center "style="font-size: 12px">Relatório de serviços realizados a partir de: </p>';
                    $html .= '<p align="center" style="font-size: 12px">'. formata_data_banco_sem_hora($data_inicial) . '</p>';
                }
                ...
                if(!empty($data_inicial)&& !empty($data_final) ){
                   $this->session->set_flashdata('info', 'Não foram encontrados Serviços entre as datas ' . formata_data_banco_sem_hora($data_inicial).'&nbsp;&nbsp;'. formata_data_banco_sem_hora($data_final)); 
                }else{
                   $this->session->set_flashdata('info', 'Não foram encontrados Serviços a partir da data ' . formata_data_banco_sem_hora($data_inicial));  
                }
...
//                
                   ...
                   $this->session->set_flashdata ('info', 'Não existem contas vencidas no momento');
...
//                
                   ...
                   $this->session->set_flashdata ('info', 'Não existem contas pagas no momento');
                   redirect('relatorios/receber');
                }
...
//                
                   ...
                   $this->session->set_flashdata ('info', 'Não existem contas a receber no momento');
                   redirect('relatorios/receber');
                }
...
//                
            ...
            if ($contas == 'pagas') {
                ...
                $data_vencimento = FALSE; //Valor falso quando estiver paga
...
//                
                   ...
                   $this->session->set_flashdata ('info', 'Não existem contas a pagar no momento');
                   redirect('relatorios/pagar');
                }
