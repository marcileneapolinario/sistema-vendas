...
class Servicos extends CI_Controller{
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('servico_descricao', '', 'trim|required|max_length[600]');
    ...
    public function check_nome_servico($servico_nome){
        ...
        if($this->core_model->get_by_id('servicos', array('servico_nome' => $servico_nome, 'sservico_id !=' => $servico_id))){
