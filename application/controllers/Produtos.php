...
class Produtos extends CI_Controller{
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('produto_preco_custo','Produto preço de custo', 'trim|required|max_length[45]');
        ...
        $this->form_validation->set_rules('produto_obs','Observação do produto', 'trim|required|max_length[500]');
