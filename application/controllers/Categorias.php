        ...
        if ($this->form_validation->run()) {
            ...
            if($this->db->table_exists('produtos')){
                ...
                if($categoria_ativa == 0 && $this->core_model->get_by_id('produtos', array('produto_categoria_id' => $categoria_id, 'produto_ativo' => 1))){
                    $this->session->set_flashdata('info', 'Esta categoria não pode ser desativada, porque está sendo utilizada em Produtos');
                    redirect('categorias');
                }
            }
            ...
            //Se houver erro de validação, recarrega a view
            $data = array(
