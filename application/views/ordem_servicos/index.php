    ...
    <div  class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova ordem de serviço" href="<?php echo base_url('os/add');?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus"></i>&nbsp;Nova</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($ordens_servicos as $os) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo ($os->ordem_servico_status == 1 ? '<span class="badge badge-info btn-sm">Paga</span>' : '<span class="badge badge-warning btn-sm">Em aberto</span>');?></td>
                                    <td class="text-right">
                                        <a title="Imprimir" href="<?php echo base_url('os/pdf/' . $os->ordem_servico_id);?>" class="btn btn-sm btn-dark"><i class="far fa-file-pdf"></i></a>
                                        <a title="Editar" href="<?php echo base_url('os/edit/' . $os->ordem_servico_id);?>" class="btn btn-sm btn-primary"><i class="far fa-edit"></i></a>
