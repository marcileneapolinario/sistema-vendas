    ...
    <div  class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova categoria"href="<?php echo base_url('categorias/add');?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus"></i></i>&nbsp;Nova</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($categorias as $categoria): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a title="Editar" href="<?php echo base_url('categorias/edit/' . $categoria->categoria_id);?>" class="btn btn-sm btn-primary"><i class="far fa-edit"></i></a>
