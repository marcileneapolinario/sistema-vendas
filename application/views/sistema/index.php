            ...
            <div class="card-body">
                <form class="user" method="POST" name="form_edit">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <label>Ordem de serviços e vendas</label>
                                <textarea class="form-control form-control-user" name="sistema_txt_ordem_servico" placeholder="Digite aqui os seus serviços"><?php echo $sistema->sistema_txt_ordem_servico; ?></textarea>
