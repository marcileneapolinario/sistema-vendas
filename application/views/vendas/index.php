                        ...
                        <tbody>
                            <?php foreach ($vendas as $venda) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a title="Imprimir" href="<?php echo base_url('vendas/pdf/' . $venda->venda_id);?>" class="btn btn-sm btn-dark"><i class="far fa-file-pdf"></i></a>
                                        <a title="Visualizar" href="<?php echo base_url('vendas/edit/' . $venda->venda_id);?>" class="btn btn-sm btn-info"><i class="far fa-eye"></i></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-primary btn-sm" href="<?php echo base_url('vendas/del/' . $venda->venda_id); ?>">Sim</a>
