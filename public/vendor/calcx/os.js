...
/*Array para armazenar temporariamente os serviços adicionados à ordem de serviço (os)*/
...
if ($counter > 0) {
    ...
    $('#table_servicos tr').each(function () {
        ...
        /*Armazena o resultado da verificação da existência do 'serviço' no array 'servicos_adicionados'*/
...
$(document).ready(function () {
    ...
    /*Previne o submit do form caso a tecla Enter seja pressionada*/
    ...
    $("#buscar_servicos").autocomplete({
        ...
        select: function (event, ui) {
            ...
            if (ui.item.value === 'Serviço não encontrado') {
                ...
                /*Fim bloco que verifica se o serviço já foi adicionado à os (ordem de serviços)*/
